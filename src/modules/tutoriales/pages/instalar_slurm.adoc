...
IMPORTANT: Las llaves se deben copiar a todos los nodos del cluster
...
IMPORTANT: El servicio chrony se debe habilitar en todos los nodos
...
NOTE: El periodo TTL es la principal razón para sincronizar los relojes de 
los nodos del cluster.

IMPORTANT: La llave munge debe ser la misma en todos los nodos del cluster.
...
NOTE: Para las distribuciones CentOS munge está en el repositorio *epel* 

NOTE: Durante la instalación se crea  automáticamente el usuario y grupo munge.

IMPORTANT: Durante la instalación *NO* se genera la *llave*, esta debe ser generada manualmente.
...
IMPORTANT: Este archivo debe tener permisos 0600, propietario y grupo munge

NOTE: Una vez creada se debe propagar la llave
...
NOTE: Se deben habilitar los repositorios *powertools* y *epel* para
estas instalaciones
