...
<1> En este directorio debe colocar el archivo _.git-credentials_. https://docs.antora.org/antora/2.3/playbook/private-repository-auth/[Private Repository Authentication].
<2> En cada directorio debe colocar el archivo _ui-bundle.zip_ correspondiente. https://docs.antora.org/antora-ui-default/build-preview-ui//[Build a UI Project for Local Preview].


[#construir_imagen]
== Construir la imágen
Desde el directorio raíz del repositorio, navegue al directorio _images_:
[source,cli]
----
$ cd images/
----
