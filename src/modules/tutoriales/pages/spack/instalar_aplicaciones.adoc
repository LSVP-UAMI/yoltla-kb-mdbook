...
[#Descripción]
== Descripción
En este documentos se describen diversas formas de realizar instalaciones en el cluster Yoltla
...
Como inconveniente se tiene la redundancia de dependencias, pero se gana claridad
y se resta complejidad.

En el Home de la cuenta spack se debe crear el directorio que albergará 
la instalación junto con sus dependencias.
...
A partir de aquí se pueden usar comando de spack sin ninguna diferencia 
al modo de trabajo regular
