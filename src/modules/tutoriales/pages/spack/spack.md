...
Para obtener más información, consulte la sección [Shell support](https://spack.readthedocs.io/en/latest/getting_started.html#shell-support) 
...
configuración los colocaremos en un nuevo directorio llamado *spack_scope*.
...
<span style="color: #990819;">*config.yaml*</span>
...
<span style="color: #990819;">*bootstrap.yaml*</span>
...
Para obtener más información, consulte la sección [Configuration Scopes](https://spack.readthedocs.io/en/latest/configuration.html#configuration-scopes) 
de la documentación oficial de Spack.
...
primera vez que se utilice, lo que se denomina bootstrapping.
...
Para obtener más información, consulte la sección [Bootstrapping clingo](https://spack.readthedocs.io/en/latest/getting_started.html#bootstrapping-clingo) d
...
Esto le permitirá cargar los módulos que se instalen en el directorio *spack_scope* 
con el comando `module load`.
