...
http://gaussian.com/[Gaussian] es un paquete de química computacional con varios métodos para calcular
...
image::Reframe/Apps/Gaussian/Figure_0979.png[]

.Performance Test 0979
|===
1.2+|*# Cores* 2+|*CPU’s Nodos nc +
...
|*time (seconds)* |*Eficiencia Paralela %* |*time (seconds)* |*Eficiencia Paralela %* |*time (seconds)*
|*Eficiencia Paralela %*
...
image::Reframe/Apps/Gaussian/Figure_1044.png[]
...
http://gaussian.com/[Gaussian Main Site]

https://gaussian.com/link0/[Link 0 Commands]

https://gaussian.com/running/[Running Gaussian]

https://nusit.nus.edu.sg/services/hpc-newsletter/running-gaussian-09-jobs-more-efficiently/[RUNNING GAUSSIAN 09 JOBS MORE EFFICIENTLY]
