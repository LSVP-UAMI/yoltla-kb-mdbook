...
https://www.quantum-espresso.org/[`Quantum Espresso`] es un conjunto de códigos Open-Source para
...
==== https://www.quantum-espresso.org/Doc/INPUT_PW.html#idm805[Método de diagonalización]

`Quantum Espresso` por default utiliza el método de
https://joshuagoings.com/2013/08/23/davidsons-method/[Davidson] (`david`) ya que es el más rápido. Para
este trabajo optamos por el uso del método
https://en.wikipedia.org/wiki/Conjugate_gradient_method[Conjugate-gradient-like] (`cg`)
ya que aunque es MUCHO más lento que `david`  usa menos memoria y es (un poco) más robusto.

==== https://www.quantum-espresso.org/Doc/INPUT_PW.html#idm1487[K_POINTS]
...
image::Reframe/Apps/QuantumEspresso/Figure_Ausurf.png["AUSURF112 Performance"]


image::Reframe/Apps/QuantumEspresso/Figure_Performance_Ausurf.png["AUSURF112 Eficiencia Paralela"]
...
|*Electrons Wall Time (s)* |*Eficiencia Paralela %* 
|*Electrons Wall Time (s)* |*Eficiencia Paralela %* 
|*Electrons Wall Time (s)* |*Eficiencia Paralela %* 
...
image::Reframe/Apps/QuantumEspresso/Figure_Grir443.png["GRIR443 Performance"]


image::Reframe/Apps/QuantumEspresso/Figure_Performance_Grir443.png["GRIR443 Eficiencia Paralela"]
...
https://es.wikipedia.org/wiki/Quantum_ESPRESSO[Quantum_ESPRESSO]

https://www.quantum-espresso.org/benchmarks/[Quantum Espresso Benchmarks]

https://www.quantum-espresso.org/Doc/INPUT_PW.html[pw.x input]
