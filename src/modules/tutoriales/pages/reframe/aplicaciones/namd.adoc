...
de grandes sistemas biomoleculares. Basado en objetos paralelos _Charm++_ , NAMD escala en cientos de
...
_Benchmark time:_ cada cien de pasos de simulación (ver el atributo `numsteps` del archivo de entrada de
...
"days/ns" presentes en _Benchmark time_.
...
https://www.ks.uiuc.edu/Research/namd/utilities/[aquí]).
...
image::Reframe/Apps/Namd/Figure_STMV.png["STMV Performance",align="center",width=1060,height=660]
...
Los datos muestran que el uso de nodos _nc_ proporciona una mejor aceleración y rendimiento
...
|*days/ns* |*Eficiencia Paralela %* |*days/ns* |*Eficiencia Paralela %* |*days/ns*
|*Eficiencia Paralela %*
...
.Performance STMV Benchmark en nodos NC.
image::Reframe/Apps/Namd/Figure_nc_error_stmv.png["STMV Performance nc"]
...
64GB RAM +
Infiniband FDR10/FDR*
1.2+|*No. Ejecuciones* 4+^.^|*days/ns* 1.2+| *Wallclock (s) Promedio*
...
.Performance STMV Benchmark en nodos TTV1.
image::Reframe/Apps/Namd/Figure_ttv1_error_stmv.png["STMV Performance ttv1"]
...
.Performance STMV Benchmark en nodos TTV2.
image::Reframe/Apps/Namd/Figure_ttv2_error_stmv.png["STMV Performance ttv2"]
...
image::Reframe/Apps/Namd/Grafica-STMV-GPU.png["STMV en gpus"]
...
20 Cores +
64GB RAM +
Infiniband FDR10/FDR* 2+|*Nodos GPUS V100 +
36 Cores +
256GB RAM +
Infiniband FDR10/FDR*

| |*days/ns* |*WallClock (s)* |*days/ns* |*WallClock (s)*
...
image::Reframe/Apps/Namd/Figure_F1atpase.png["F1ATPase Performance"]
...
Los datos muestran que el uso de nodos _nc_ proporciona un mejor rendimiento en las distintas
...
image::Reframe/Apps/Namd/Figure_nc_error_f1atpase.png["F1ATPase Performance nc"]
...
image::Reframe/Apps/Namd/Figure_ttv1_error_f1atpase.png["F1ATPase Performance ttv1"]
...
image::Reframe/Apps/Namd/Figure_ttv2_error_f1atpase.png["F1ATPase Performance ttv2"]
...
image::Reframe/Apps/Namd/Grafica-ATPASE-GPU.png["ATPase en GPUS"]
...
https://www.ks.uiuc.edu/Research/namd/utilities/[NAMD Benchmarks]

https://www.ks.uiuc.edu/Research/namd/2.13/ug/node91.html[NAMD Performance]

http://www.ks.uiuc.edu/Training/Tutorials/namd/namd-tutorial-win-html/node28.html[NAMD Standard Output]

https://www.ks.uiuc.edu/Research/STMV/#stmv[Satellite Tobacco Mosaic Virus (STMV)]

https://www.ks.uiuc.edu/Research/atp_hydrolysis/[ATP hydrolysis in F1-ATPase]
