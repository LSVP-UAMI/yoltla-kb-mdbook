...
https://manual.gromacs.org/documentation/current/user-guide/mdrun-performance.html[mdrun-performance]
...
Los algoritmos de
https://manual.gromacs.org/documentation/current/onlinehelp/gmx-mdrun.html#gmx-mdrun[`gmx mdrun`]
...
opciones de
https://manual.gromacs.org/documentation/current/user-guide/mdrun-performance.html#controlling-the-domain-decomposition-algorithm[línea de comandos]
...
sistema adecuada (por ejemplo, _OMP_NUM_THREADS_) si está configurada. Tenga en cuenta que la
...
https://www.hecbiosim.ac.uk/access-hpc/benchmarks[HECBioSim]
...
* Input parameters: https://docs.bioexcel.eu/gromacs_bpg/en/master/cookbook/benchmarks/20k_HBS.html[20k_HBS.mdp]
...
* Input parameters: https://docs.bioexcel.eu/gromacs_bpg/en/master/cookbook/benchmarks/465k_HBS.html[465k_HBS.mdp]
...
image::Reframe/Apps/Gromacs/Figure_crambin.png[]

.Performance 20K atom system: Crambin Benchmark
|===
1.2+|*# Nodos* 3+|*CPU’s Nodos nc +
20 Cores x 2.50GHz Intel Xeón E5-2670v2 +
64GB RAM +
Infiniband FDR10/FDR* 3+|*CPU’s Nodos ttv1[1-58] +
20 Cores x 2.60GHz Intel Xeón E5-2660v3 +
128GB RAM +
Infiniband FDR10/FDR* 3+|*CPU’s Nodos ttv2[59-104] +
32 Cores x 2.10GHz Intel Xeon E5-2683v4 +
256GB RAM +
Infiniband FDR10/FDR*

|*ns/day* |*Wall t(s)* |*Eficiencia Paralela %*
|*ns/day* |*Wall t(s)* |*Eficiencia Paralela %*
|*ns/day* |*Wall t(s)* |*Eficiencia Paralela %*
...
image::Reframe/Apps/Gromacs/Figure_glutamine.png[]
...
image::Reframe/Apps/Gromacs/Figure_dimer.png[]
...
image::Reframe/Apps/Gromacs/Figure_dimer_pair.png[]
...
image::Reframe/Apps/Gromacs/Figure_tetramers.png[]
...
.Performance Tetramers Benchmark en nodos NC
image::Reframe/Apps/Gromacs/Figure_error_nc_tetramers.png[]
...
64GB RAM +
Infiniband FDR10/FDR*
1.2+|*No. Ejecuciones* 4+^.^|*ns/day* 1.2+| *Wallclock (s) Promedio*
...
.Performance Tetramers Benchmark en nodos TTV1
image::Reframe/Apps/Gromacs/Figure_error_ttv1_tetramers.png[]
...
.Performance Tetramers Benchmark en nodos TTv2
image::Reframe/Apps/Gromacs/Figure_error_ttv2_tetramers.png[]
...
.Uso de GPU además de rangos MPI y subprocesos OpenMP para explorar el paralelismo.
image::Reframe/Apps/Gromacs/MPIandOpenMPandGPU.png[]
...
_Non-default thread affinity set, disabling internal thread affinity_
...
image::Reframe/Apps/Gromacs/Figure_tetramer-Gpu.png[]

.Performance Tetramers Benchmark en GPUS
|===
|*# GPU devices* 2+|*Nodos GPUS Tesla K20 +
20 Cores +
64GB RAM +
Infiniband FDR10/FDR* 2+|*Nodos nc con GPUS V100 +
36 Cores +
256GB RAM +
Infiniband FDR10/FDR*

| |*ns/day* |*Wall time (s)* |*ns/day* |*Wall time (s)*
...
https://www.hecbiosim.ac.uk/access-hpc/benchmarks[The HECBioSim Benchmarks]

https://manual.gromacs.org/documentation/current/user-guide/mdrun-performance.html[mdrun performance]

https://docs.bioexcel.eu/gromacs_bpg/en/master/cookbook/cookbook.html[Performance Cookbook]

https://enccs.github.io/gromacs-gpu-performance/[GROMACS GPU performance]

https://manual.gromacs.org/documentation/2018.1/user-guide/mdrun-performance.html#gpu-accelerated-calculation-of-pme[GPU accelerated calculation of PME]
