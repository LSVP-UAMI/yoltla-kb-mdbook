...
El software https://www.nwchem-sw.org/[NWChem] contiene herramientas de química computacional que son
...
.Arquitectura de NWChem
image::Reframe/Apps/NWChem/nwchem-arch.png[]
...
biblioteca `MPI` utilizada y cómo _Global Arrays_ usa `MPI`. A diferencia de muchos códigos HPC, _Global Arrays_
...
La siguiente imagen (Imagen 2) contiene detalles de lo que sucede dentro de _Global Arrays_.


.Asignación de ARMCI a MPI
image::Reframe/Apps/NWChem/armci.png[]
...
https://nwchemgit.github.io/Memory.html[MEMORY]
...
https://nwchemgit.github.io/Density-Functional-Theory-for-Molecules.html[DFT] 
totales en el nivel teórico 
https://en.wikipedia.org/wiki/Local-density_approximation[LDA]
...
por la directiva 
https://nwchemgit.github.io/TASK.html[TASK]. 
...
https://nwchemgit.github.io/Benchmarks.html#hybrid-density-functional-calculation-on-the-c240-buckyball[aquí].

La simulación debe llegar a un valor `Total DFT energy` cercano a: `-9136.856741718977`

.Performance C240 Benchmark
image::Reframe/Apps/NWChem/Figure_C240.png[]
...
|*Wall time (s)* |*Eficiencia Paralela %*
|*Wall time (s)* |*Eficiencia Paralela %*
|*Wall time (s)* |*Eficiencia Paralela %*
...
.Performance C240 Benchmark en nodos nc.
image::Reframe/Apps/NWChem/Figure_error_nc_c240.png["C240 Performance nc"]

{empty} +

.Performance C240 Benchmark en nodos nc.
|===
1.3+|*# Nodos* 5+|*CPU’s Nodos nc +
20 Cores x 2.50GHz Intel Xeón E5-2670v2 +
64GB RAM +
Infiniband FDR10/FDR*
1.2+|*No. Ejecuciones* 4+^.^|*Wall time (s)*
...
.Performance C240 Benchmark en nodos ttv1.
image::Reframe/Apps/NWChem/Figure_error_ttv1_c240.png["C240 Performance ttv1"]

{empty} +

.Performance C240 Benchmark en nodos ttv1.
|===
1.3+|*# Nodos* 5+|*CPU’s Nodos ttv1 +
20 Cores x 2.60GHz Intel Xeón E5-2660v3 +
128GB RAM +
Infiniband FDR10/FDR*
1.2+|*No. Ejecuciones* 4+^.^|*Wall time (s)*
...
.Performance C240 Benchmark en nodos ttv2.
image::Reframe/Apps/NWChem/Figure_error_ttv2_c240.png["C240 Performance ttv2"]

{empty} +

.Performance C240 Benchmark en nodos ttv2.
|===
1.3+|*# Nodos* 5+|*CPU’s Nodos ttv2 +
32 Cores x 2.10GHz Intel Xeon E5-2683v4 +
256GB RAM +
Infiniband FDR10/FDR*
1.2+|*No. Ejecuciones* 4+^.^|*Wall time (s)*
...
https://nwchemgit.github.io/Benchmarks.html#density-functional-calculation-of-a-zeolite-fragment[enlace].

La simulación debe llegar a un valor `Total DFT energy` cercano a: `-65667.628352536878`

.Performance Siosi8 Benchmark
image::Reframe/Apps/NWChem/Figure_Siosi8.png[]

.Performance Siosi8 Benchmark
|===
1.2+|*# Nodos* 1+|*CPU’s Nodos nc +
20 Cores x 2.50GHz Intel Xeón E5-2670v2 +
64GB RAM +
Infiniband FDR10/FDR* 1+|*CPU’s Nodos ttv1[1-58] +
20 Cores x 2.60GHz Intel Xeón E5-2660v3 +
128GB RAM +
Infiniband FDR10/FDR* 1+|*CPU’s Nodos ttv2[59-104] +
32 Cores x 2.10GHz Intel Xeon E5-2683v4 +
256GB RAM +
Infiniband FDR10/FDR*
...
https://nwchemgit.github.io/[NWChem Website]

https://nwchemgit.github.io/Benchmarks.html[Benchmarks performed with NWChem]

https://nwchemgit.github.io/FAQ.html[General information about NWChem]

https://nwchemgit.github.io/Memory.html[NWChem memory]

https://nwchemgit.github.io/Density-Functional-Theory-for-Molecules.html[Density Functional Theory (NWChem DFT)]

https://nwchemgit.github.io/TASK.html[NWChem Task]
