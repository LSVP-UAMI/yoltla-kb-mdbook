...
Para obtener más información, consulte la documentación oficial de https://reframe-hpc.readthedocs.io/en/stable/[ReFrame].
...
Para obtener más información, consulte la sección https://reframe-hpc.readthedocs.io/en/stable/started.html#getting-the-framework[Getting the Framework] de la documentación oficial de ReFrame.
...
Primero, cree el directorio _reframe_:
----
[t.800@yoltla ~]$ mkdir reframe
----

y dentro de este directorio cree el archivo xref:attachment$reframe/settings.py[_settings.py_]:
...
Para obtener más información, consulte la sección https://reframe-hpc.readthedocs.io/en/stable/configure.html#configuring-reframe-for-your-site[Configuring ReFrame for Your Site] de la documentación oficial de ReFrame.
...
Para obtener más información, consulte la sección https://reframe-hpc.readthedocs.io/en/stable/started.html#enabling-auto-completion[Enabling auto-completion] de la documentación oficial de ReFrame.
...
Esto creará un nuevo directorio llamado _reframe_:
----
[t.800@yoltla git]$ ls
reframe
----
