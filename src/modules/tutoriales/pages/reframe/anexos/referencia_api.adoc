...
Para obtener más información, consulte la sección https://reframe-hpc.readthedocs.io/en/stable/regression_test_api.html#test-api-reference[Test API Reference] de la documentación oficial de ReFrame.
...
personalizar su funcionamiento a medida que se ejecutan adjuntando xref:#enlaces_pipeline[enlaces] a las
...
Para obtener más información, consulte la sección https://reframe-hpc.readthedocs.io/en/stable/pipeline.html#the-regression-test-pipeline[The Regression Test Pipeline] de la documentación oficial de ReFrame.
...
Base: xref:#run_regression[RegressionTest]
+
...
*** *Type*: str o https://reframe-hpc.readthedocs.io/en/stable/regression_test_api.html?highlight=api%20#reframe.core.buildsystems.BuildSystem[reframe.core.buildsystems.BuildSystem]
*** *Default*: `None`
...
Eche un vistazo al atributo xref:#extra_resources[`extra_resources`].
+
...
+
Para obtener más información, consulte la sección de xref:reframe/scripts/pruebas_sanidad.adoc#funciones_diferibles[Funciones Diferibles].
...
+
Para obtener más información, consulte la sección de xref:reframe/scripts/pruebas_rendimiento.adoc#funciones_diferibles[Pruebas de rendimiento].
...
inicialice la prueba (es decir, después de que se llame el método __init__()) y antes de ingresar al
...
+
Consulte la sección xref:#enlaces_pipeline[Enlaces Pipeline]. 
...
+
Para obtener más información, consulte la sección de xref:reframe/scripts/pruebas_sanidad.adoc[Pruebas de sanidad].
...
Los _Enlaces Pipeline_ son muy útiles ya que existen variables que solo se pueden consultar, definir o modificar
después o antes de que Reframe haya pasado por ciertas etapas del xref:#pipeline[`Pipeline`]. Algunas de estas variables son:
...
sección xref:reframe/scripts/parametros.adoc[Parámetros] para más información. Estos se definen 
...
Para obtener más información, consulte la sección de xref:reframe/scripts/parametros.adoc[Parámetros].


[#programadores_trabajos_lanzadores_paralelos]
...
[#atributos_programador_trabajos]
...
Para obtener más información, consulte la consulte la sección xref:reframe/anexos/archivo_configuracion.adoc#configuracion_schedulers[Configuracion de schedulers].
====
