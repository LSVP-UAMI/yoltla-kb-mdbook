...
específicamente dirigido a sistemas HPC. El objetivo de este framework es abstraer 
la complejidad de las interacciones con el sistema, separando la lógica de una 
prueba de los detalles de bajo nivel.
...
y en conjunto con el sistema de colas del clúster Yoltla, crearemos nuestra propia 
configuración.
...
y dentro de este directorio cree el archivo [*settings.py*](../../attachments/reframe/topologia/settings.py):
...
Para indicarle a ReFrame que utilice esta nueva configuración debe usar el comando 
`reframe` siguiendo el formato:
...
y aplicaciones. Para acceder al repositorio, ingrese a la URL:
...
Para obtener más información del contenido de estos directorios, consulte la sección 
correspondiente.
