...
Para obtener más información, visite el sitio oficial de https://www.cs.virginia.edu/stream/[STREAM].


[#compilacion]
== Compilación

1. Descargue el https://www.cs.virginia.edu/stream/FTP/Code/[código fuente] del benchmark STREAM:
+
[source, shell]
----
...
|-O
|Compila el código con optimizaciones. +
Se recomienta utilizar siempre esta opción.

|-fopenmp
|Habilita el manejo de directivas OpenMP.

|-D_OPENMP
|Activa una combinación de MPI y OpenMP para la paralelización.

|-DSTREAM_ARRAY_SIZE=#
|Define el tamaño de la matriz. +
El valor por defecto es 10,000,000.

|-DNTIMES=#
|Define el número de veces que se ejecutará cada kernel. +
Se informa el mejor resultado. +
El valor por defecto es 10.

|-DOFFSET=#
|Modifica el valor de la variable `OFFSET`. +
Cambia la alineación relativa de las matrices. +
El valor por defecto es 0.
|===

En el archivo fuente _stream.c_ puede encontrar más información acerca de estas opciones.
====
...
Dentro de la carpeta raíz _stream_ existen tres subdirectorios, uno por cada tipo de nodo en el cluster Yoltla:
...
. Ubíquese en el directorio raíz _stream_:
+
[source, shell]
----
[t.800@yoltla stream]$ 
...
.Resultados del benchmark STREAM en los nodos NC
image::Reframe/microBenchmarks/memoria/stream/nc.png["Resultados del benchmark STREAM en los nodos NC", link="../../../_images/Reframe/microBenchmarks/memoria/stream/nc.png"]
...
.Resultados del benchmark STREAM en los nodos TTv1
image::Reframe/microBenchmarks/memoria/stream/ttv1.png["Resultados del benchmark STREAM en los nodos TTv1", link="../../../_images/Reframe/microBenchmarks/memoria/stream/ttv1.png"]
...
.Resultados del benchmark STREAM en los nodos TTv2
image::Reframe/microBenchmarks/memoria/stream/ttv2.png["Resultados del benchmark STREAM en los nodos TTv2", link="../../../_images/Reframe/microBenchmarks/memoria/stream/ttv2.png"]
...
.Resultados del benchmark STREAM en el cluster Yoltla
image::Reframe/microBenchmarks/memoria/stream/yoltla.png["Resultados del benchmark STREAM en el cluster Yoltla", link="../../../_images/Reframe/microBenchmarks/memoria/stream/yoltla.png"]
...
* https://www.cs.virginia.edu/stream/[STREAM: Sustainable Memory Bandwidth in High Performance Computers]
* https://www.admin-magazine.com/HPC/Articles/Finding-Memory-Bottlenecks-with-Stream[Benchmarking Memory Bandwidth]
* https://www.intel.com/content/www/us/en/developer/articles/technical/optimizing-memory-bandwidth-on-stream-triad.html[Optimizing Memory Bandwidth on Stream Triad]
* https://developer.amd.com/spack/stream-benchmark/[AMD | STREAM Benchmark]