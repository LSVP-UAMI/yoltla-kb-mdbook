...
A continuación se presenta la salida de una ejecución de esta prueba:
    ...
    1357905920 bytes (1.4 GB, 1.3 GiB) copied, 7 s, 194 MB/s            
    2048+0 records in                                                   
    2048+0 records out                                                  
    2147483648 bytes (2.1 GB, 2.0 GiB) copied, 7.73725 s, 278 MB/s      
...
- Bytes copiados, tiempo de ejecución, velocidad final de lectura
...
Dentro de la carpeta raíz *diskread* existen tres subdirectorios, uno por cada tipo de nodo en el cluster Yoltla:
...
![Resultados de la prueba DiskRead en los nodos NC](Reframe/microBenchmarks/disco/diskread/nc.png)
...
![Resultados de la prueba DiskRead en los nodos TTv1](Reframe/microBenchmarks/disco/diskread/ttv1.png)
...
![Resultados de la prueba DiskRead en los nodos TTv2](Reframe/microBenchmarks/disco/diskread/ttv2.png)
...
![Resultados de la prueba DiskRead en el cluster Yoltla](Reframe/microBenchmarks/disco/diskread/yoltla.png)
