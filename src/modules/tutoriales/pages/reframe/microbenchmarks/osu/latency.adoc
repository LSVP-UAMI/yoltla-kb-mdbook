...
image::Reframe/microBenchmarks/osu/latency/Figure_osu.png[]
...
https://reframe-hpc.readthedocs.io/en/stable/hpctestlib.html[ReFrame Test Library: OSU microbenchmarks]
