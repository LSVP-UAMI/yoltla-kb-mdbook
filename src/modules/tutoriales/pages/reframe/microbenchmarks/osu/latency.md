...
será el rendimiento que podemos obtener.

Uno de los principales factores que influyen en el rendimiento de las aplicaciones HPC
es la latencia de las operaciones de transferencia de datos. InfiniBand aborda el desafío 
de la latencia con un enfoque doble: por un lado, proporciona una latencia de red extremadamente 
baja y, por otro lado, presenta herramientas inteligentes para mejorar la latencia de las 
operaciones de datos complejos.

Estas ventajas distinguen a InfiniBand como la solución de interconexión líder para las 
plataformas de supercomputación actuales y futuras.
...
La latencia (us -- micro-segundos) que se indica a continuación es el promedio de la 
ejecución del benchmark Osu en diferentes nodos para un mensaje de 512 MB con 5,000 
...
```
\
<span style="color: #990819;">*Salida OSU MPI: All-to-all en 2 nodos NC*</span>
...
```
\
<span style="color: #990819;">*Salida OSU MPI: All-to-all en 4 nodos NC*</span>
...
```
\
<span style="color: #990819;">*Salida OSU MPI: All-to-all en 8 nodos NC*</span>
...
```
\
<span style="color: #990819;">*Salida OSU MPI: All-to-all en 16 nodos NC*</span>
...
```
\
<span style="color: #990819;">*Salida OSU MPI: All-to-all en 2 nodos TTV1*</span>
...
```
\
<span style="color: #990819;">*Salida OSU MPI: All-to-all en 4 nodos TTV1*</span>
...
```
\
<span style="color: #990819;">*Salida OSU MPI: All-to-all en 5 nodos TTV1*</span>
...
```
\
<span style="color: #990819;">*Salida OSU MPI: All-to-all en 8 nodos TTV1*</span>
...
```
\
<span style="color: #990819;">*Salida OSU MPI: All-to-all en 16 nodos TTV1*</span>
...
```
\
<span style="color: #990819;">*Salida OSU MPI: All-to-all en 2 nodos TTV2*</span>
...
```
\
<span style="color: #990819;">*Salida OSU MPI: All-to-all en 4 nodos TTV2*</span>
...
```
\
<span style="color: #990819;">*Salida OSU MPI: All-to-all en 8 nodos TTV2*</span>
...
```
\
<span style="color: #990819;">*Salida OSU MPI: All-to-all en 16 nodos TTV2*</span>
